        ...
        for CHUNK in "${CHUNKS[@]}"; do
            if [ "$CHUNK" == 'big_high_block_1' ]; then 
                ...
                for PATCH in "${PATCHS[@]}"; do
                    ...
                    tar -xvf ./dataset/MatrixCity/big_city/aerial/${SPLIT}/${PATCH} -C ./dataset/MatrixCity/big_city/aerial/${SPLIT}/${CHUNK}/
                    rm ./dataset/MatrixCity/big_city/aerial/${SPLIT}/${PATCH}
                done
