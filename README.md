...
- [ ] 2.Complete the technical方案 (scheme) designed for the project, including detailed technical implementation details and possible difficulties
- [ ] 2.Use DepthAnything to perform unconstrained 3D reconstruction representation on the dataset images, and calculate the corresponding AUC and F1 metrics
- [ ] 3.Use SAM3D for relevant 3D reconstruction representation of the map to form corresponding data assets

## :file_folder: 2.Download Dataset :file_folder:
...
## :date: 3.Evaluation Metrics :date:
...
```bash
# You can st your own save_dir pat
...
## :video_camera: 3.Demo Show :video_camera:
