...
from da3mvs.app.modules.utils import get_logo_base64, get_scene_info
...
class UIComponents:
    ...
    def create_measure_section(
        ...
        """
        from da3mvs.app.css_and_html import MEASURE_INSTRUCTIONS_HTML
    ...
    def create_header_section(self) -> gr.HTML:
        ...
        """
        from da3mvs.app.css_and_html import get_header_html
    ...
    def create_description_section(self) -> gr.HTML:
        ...
        """
        from da3mvs.app.css_and_html import get_description_html
    ...
    def create_acknowledgements_section(self) -> gr.HTML:
        ...
        """
        from da3mvs.app.css_and_html import get_acknowledgements_html
