...
from da3lora.app.css_and_html import GRADIO_CSS, get_gradio_theme
from da3lora.app.modules.event_handlers import EventHandlers
from da3lora.app.modules.ui_components import UIComponents
...
class DepthAnything3App:
    ...
    def cache_examples(
        ...
        """
        from da3lora.app.modules.utils import get_scene_info
