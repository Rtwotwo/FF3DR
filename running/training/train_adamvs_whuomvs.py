...
from running.training.datasets_adamvs.data_io import save_pfm
...
parser.add_argument('--trainpath', default='/data2/dataset/Redal/work_feedforward_3drepo/dataset/WHU-OMVS/train', help='train datapath')
parser.add_argument('--testpath', default='/data2/dataset/Redal/work_feedforward_3drepo/dataset/WHU-OMVS/test', help='test datapath or validation datapath')
parser.add_argument('--loadckpt', default='/data2/dataset/Redal/work_feedforward_3drepo/weights/adamvs/model_000014_0.1409.ckpt', help='load checkpoints')
parser.add_argument('--logdir', default='./exp/adamvs_whuomvs', help='the directory to save checkpoints/logs')
...
if args.model == 'msrednet':
    from models.adamvs.msrednet import CascadeREDNet, cas_rednet_loss
    ...
    from models.adamvs.adamvs import AdaMVSNet, cas_mvs_vis_loss
