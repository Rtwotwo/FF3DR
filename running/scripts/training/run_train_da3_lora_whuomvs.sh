#!/bin/bash
# Fine-tune DA3-Large with LoRA for depth-only supervision on WHU-OMVS
#
# Key changes:
#   - Single-stage depth-only fine-tuning
#   - Median-aligned supervision on WHU-OMVS train depth GT
#   - No DSM MAE/PAG optimization
#   - Validation on both val split (area1) and test split (area2+area3)
#   - TensorBoard groups: epoch / lr / train / val / test
#   - Print every 500 steps
#   - Single GPU (GPU 0, 24GB free), batch_size=4, grad_accum=2
#
...
OUTPUT_DIR="${PROJECT_ROOT}/exp/whu-omvs/train_lora_da3/da3_large_lora_whuomvs_0523"
...
echo "============================================"
echo "DA3-Large LoRA Depth-Only Fine-tuning"
echo "============================================"
...
echo "Epochs:         ${EPOCHS} (single-stage)"
